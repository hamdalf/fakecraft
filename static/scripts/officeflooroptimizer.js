...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var cubeTextureTest = function () {
        var cG = new THREE.BoxGeometry(10, 20, 30);
        ...
        cube.material.map.repeat.y = 2;
        cube.position.y = 50;
        console.log(cube.geometry.parameters.depth);
        scene.add(cube);
    };
    
    buttons[2].addEventListener('click', cubeTextureTest, false);
